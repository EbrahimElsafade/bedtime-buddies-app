  ...
  return (
    ...
    `}>
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        {/* Floating bubbles */}
        <div className="absolute top-20 left-10 w-4 h-4 bg-primary rounded-full animate-bubble opacity-30" />
        ...
        <div className="absolute top-60 left-1/3 w-2 h-2 bg-primary-foreground rounded-full animate-bubble animation-delay-2000 opacity-50" />
