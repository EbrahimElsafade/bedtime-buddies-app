...
const Hero = () => {
  ...
  return (
    <section className="py-8 md:py-12 lg:py-20 px-4 relative overflow-hidden fun-cursor">
      ...
      {/* NEW ELEMENTS - More captivating additions */}
      
      {/* Rocket Ship */}
      <div className="absolute top-14 right-40 animate-float" style={{ animationDelay: '1.6s' }}>
      ...
      {/* Ice Cream */}
      <div className="absolute bottom-24 right-20 animate-bounce-gentle" style={{ animationDelay: '3.1s' }}>
      ...
      {/* Teddy Bear */}
      <div className="absolute top-60 left-12 animate-wiggle" style={{ animationDelay: '2.2s' }}>
      ...
      {/* Musical Notes */}
      <div className="absolute top-36 left-20 animate-twinkle" style={{ animationDelay: '1.1s' }}>
      ...
      {/* Lollipop */}
      <div className="absolute bottom-48 right-12 animate-float" style={{ animationDelay: '3.8s' }}>
      ...
      {/* Dinosaur */}
      <div className="absolute top-52 right-8 animate-bounce-gentle" style={{ animationDelay: '2.7s' }}>
      ...
      {/* Cupcake */}
      <div className="absolute bottom-12 left-28 animate-twinkle" style={{ animationDelay: '3.5s' }}>
      ...
      {/* Kite */}
      <div className="absolute top-24 left-60 animate-float" style={{ animationDelay: '0.9s' }}>
      ...
      {/* Pizza Slice */}
      <div className="absolute top-44 right-36 animate-wiggle" style={{ animationDelay: '2.9s' }}>
        <svg width="30" height="25" viewBox="0 0 30 25" fill="none" className="opacity-60">
      ...
      {/* Fairy */}
      <div className="absolute bottom-20 left-52 animate-float" style={{ animationDelay: '1.3s' }}>
      ...
      {/* Train */}
      <div className="absolute top-28 right-48 animate-bounce-gentle" style={{ animationDelay: '3.4s' }}>
      ...
      {/* Robot */}
      <div className="absolute bottom-36 right-28 animate-twinkle" style={{ animationDelay: '1.9s' }}>
        <svg width="30" height="35" viewBox="0 0 30 35" fill="none" className="opacity-60">
