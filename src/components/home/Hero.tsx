...
const Hero = () => {
  ...
  return (
    <section className="py-8 md:py-12 lg:py-20 px-4 relative overflow-hidden fun-cursor">
      ...
      {/* Rainbow - spread to left side */}
      <div className="absolute top-[20%] left-[5%] animate-float" style={{ animationDelay: '0.8s' }}>
        <svg width="80" height="40" viewBox="0 0 60 30" fill="none" className="opacity-60">
      ...
      {/* Cloud - spread to top right */}
      <div className="absolute top-[8%] right-[10%] animate-float" style={{ animationDelay: '1.2s' }}>
        <svg width="70" height="40" viewBox="0 0 50 30" fill="none" className="opacity-50">
      ...
      {/* Balloon - spread to bottom left */}
      <div className="absolute bottom-[15%] left-[8%] animate-float" style={{ animationDelay: '2.1s' }}>
        <svg width="35" height="50" viewBox="0 0 25 40" fill="none" className="opacity-70">
      ...
      {/* Shooting Star - spread to top center */}
      <div className="absolute top-[12%] right-[25%] animate-twinkle" style={{ animationDelay: '1.8s' }}>
        <svg width="50" height="25" viewBox="0 0 40 20" fill="none" className="opacity-80">
      ...
      {/* Magic Wand - spread to bottom right */}
      <div className="absolute bottom-[20%] right-[12%] animate-wiggle" style={{ animationDelay: '2.5s' }}>
        <svg width="40" height="40" viewBox="0 0 30 30" fill="none" className="opacity-60">
      ...
      {/* Castle - spread to left center */}
      <div className="absolute top-[35%] left-[3%] animate-float" style={{ animationDelay: '3.2s' }}>
        <svg width="60" height="45" viewBox="0 0 45 35" fill="none" className="opacity-50">
      ...
      {/* Butterfly - spread to right center */}
      <div className="absolute top-[40%] right-[8%] animate-bounce-gentle" style={{ animationDelay: '1.4s' }}>
        <svg width="45" height="35" viewBox="0 0 35 25" fill="none" className="opacity-70">
      ...
      {/* Sun - spread to top left */}
      <div className="absolute top-[6%] left-[15%] animate-twinkle" style={{ animationDelay: '0.3s' }}>
        <svg width="50" height="50" viewBox="0 0 40 40" fill="none" className="opacity-60">
      ...
      {/* Flower - spread to bottom center-left */}
      <div className="absolute bottom-[25%] left-[20%] animate-float" style={{ animationDelay: '2.8s' }}>
        <svg width="40" height="45" viewBox="0 0 30 35" fill="none" className="opacity-60">
      ...
      {/* Rocket Ship - spread to right side */}
      <div className="absolute top-[15%] right-[5%] animate-float" style={{ animationDelay: '1.6s' }}>
        <svg width="45" height="60" viewBox="0 0 35 50" fill="none" className="opacity-75">
      ...
      {/* Ice Cream - spread to bottom right */}
      <div className="absolute bottom-[10%] right-[20%] animate-bounce-gentle" style={{ animationDelay: '3.1s' }}>
        <svg width="35" height="55" viewBox="0 0 25 45" fill="none" className="opacity-70">
      ...
      {/* Teddy Bear - spread to left side */}
      <div className="absolute top-[45%] left-[2%] animate-wiggle" style={{ animationDelay: '2.2s' }}>
        <svg width="50" height="50" viewBox="0 0 40 40" fill="none" className="opacity-65">
      ...
      {/* Musical Notes - spread to center */}
      <div className="absolute top-[25%] left-[45%] animate-twinkle" style={{ animationDelay: '1.1s' }}>
        <svg width="40" height="35" viewBox="0 0 30 25" fill="none" className="opacity-60">
      ...
      {/* Lollipop - spread to center right */}
      <div className="absolute bottom-[35%] right-[30%] animate-float" style={{ animationDelay: '3.8s' }}>
        <svg width="30" height="50" viewBox="0 0 20 40" fill="none" className="opacity-70">
      ...
      {/* Dinosaur - spread to top right area */}
      <div className="absolute top-[30%] right-[2%] animate-bounce-gentle" style={{ animationDelay: '2.7s' }}>
        <svg width="55" height="45" viewBox="0 0 45 35" fill="none" className="opacity-60">
      ...
      {/* Cupcake - spread to bottom left */}
      <div className="absolute bottom-[8%] left-[25%] animate-twinkle" style={{ animationDelay: '3.5s' }}>
        <svg width="35" height="40" viewBox="0 0 25 30" fill="none" className="opacity-75">
      ...
      {/* Kite - spread to top center left */}
      <div className="absolute top-[18%] left-[30%] animate-float" style={{ animationDelay: '0.9s' }}>
        <svg width="40" height="45" viewBox="0 0 30 35" fill="none" className="opacity-65">
      ...
      {/* Pizza Slice - spread to right center */}
      <div className="absolute top-[50%] right-[15%] animate-wiggle" style={{ animationDelay: '2.9s' }}>
        <svg width="40" height="35" viewBox="0 0 30 25" fill="none" className="opacity-60">
      ...
      {/* Fairy - spread to bottom center */}
      <div className="absolute bottom-[12%] left-[40%] animate-float" style={{ animationDelay: '1.3s' }}>
        <svg width="35" height="45" viewBox="0 0 25 35" fill="none" className="opacity-70">
      ...
      {/* Train - spread to top right */}
      <div className="absolute top-[22%] right-[35%] animate-bounce-gentle" style={{ animationDelay: '3.4s' }}>
        <svg width="60" height="35" viewBox="0 0 50 25" fill="none" className="opacity-65">
      ...
      {/* Robot - spread to bottom right center */}
      <div className="absolute bottom-[18%] right-[40%] animate-twinkle" style={{ animationDelay: '1.9s' }}>
        <svg width="40" height="45" viewBox="0 0 30 35" fill="none" className="opacity-60">
      ...
      {/* More sparkle effects spread across */}
      <div className="absolute top-[10%] left-[60%] w-1 h-1 bg-dream-DEFAULT rounded-full animate-twinkle" style={{ animationDelay: '0.2s' }}></div>
      <div className="absolute top-[55%] right-[50%] w-2 h-2 bg-moon-light rounded-full animate-twinkle" style={{ animationDelay: '2.3s' }}></div>
      <div className="absolute bottom-[30%] left-[55%] w-1.5 h-1.5 bg-dream-light rounded-full animate-twinkle" style={{ animationDelay: '1.7s' }}></div>
      <div className="absolute bottom-[40%] right-[60%] w-1 h-1 bg-moon-DEFAULT rounded-full animate-twinkle" style={{ animationDelay: '3.1s' }}></div>
      <div className="absolute top-[35%] left-[70%] w-1.5 h-1.5 bg-dream-DEFAULT rounded-full animate-twinkle" style={{ animationDelay: '2.8s' }}></div>
      <div className="absolute top-[65%] left-[35%] w-1 h-1 bg-moon-light rounded-full animate-twinkle" style={{ animationDelay: '1.4s' }}></div>
    </section>
  );
};
