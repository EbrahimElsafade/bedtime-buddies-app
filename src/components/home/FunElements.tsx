  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
      ...
      <div className="absolute top-[12%] right-[8%] animate-float" style={{ animationDelay: "1.5s" }}>
        <Baby className="h-10 w-10 text-dream-light opacity-80" />
      </div>
      <div className="absolute top-[25%] left-[12%] animate-float" style={{ animationDelay: "2.3s" }}>
        <Rocket className="h-9 w-9 text-dream-DEFAULT opacity-70" />
      </div>
      ...
      <div className="absolute top-[55%] left-[6%] animate-float" style={{ animationDelay: "0.8s" }}>
        <Cake className="h-10 w-10 text-dream-DEFAULT opacity-70" />
      </div>
      ...
      <div className="absolute top-[35%] right-[15%] animate-float" style={{ animationDelay: "2.8s" }}>
        <Crown className="h-8 w-8 text-dream-light opacity-70" />
      </div>
      ...
      <div className="absolute top-[75%] right-[25%] animate-float" style={{ animationDelay: "3.5s" }}>
        <Sparkles className="h-9 w-9 text-dream-DEFAULT opacity-75" />
      </div>
      ...
      <div className="absolute top-[15%] left-[45%] animate-twinkle" style={{ animationDelay: "0.3s" }}>
        <Star className="h-4 w-4 text-dream-light opacity-50" />
      </div>
      ...
      <div className="absolute top-[32%] left-[50%] animate-twinkle" style={{ animationDelay: "1.6s" }}>
        <Star className="h-4 w-4 text-dream-DEFAULT opacity-45" />
      </div>
      ...
      <div className="absolute top-[16%] left-[22%] w-20 h-20 rounded-full bg-gradient-to-br from-dream-light/15 to-dream-DEFAULT/5 animate-float blur-sm" style={{ animationDelay: "1.9s" }}></div>
      ...
      <div className="absolute top-[72%] right-[28%] w-24 h-24 rounded-full bg-gradient-to-bl from-dream-DEFAULT/8 to-dream-light/3 animate-float blur-md" style={{ animationDelay: "2.7s" }}></div>
      ...
      <div className="absolute top-[52%] right-[12%] w-0 h-0 border-l-[20px] border-l-transparent border-b-[40px] border-b-dream-light/25 border-r-[20px] border-r-transparent animate-float" style={{ animationDelay: "0.5s" }}></div>
      <div className="absolute top-[11%] left-[40%] w-12 h-12 bg-gradient-to-br from-dream-DEFAULT/15 to-dream-light/10 rounded-full animate-float" style={{ animationDelay: "2.9s" }}></div>
      ...
      <div className="absolute top-[20%] left-[60%] w-2 h-2 bg-dream-light rounded-full animate-twinkle" style={{ animationDelay: "0.7s" }}></div>
      <div className="absolute top-[22%] left-[62%] w-1 h-1 bg-moon-DEFAULT rounded-full animate-twinkle" style={{ animationDelay: "1.1s" }}></div>
      <div className="absolute top-[24%] left-[64%] w-1.5 h-1.5 bg-dream-DEFAULT rounded-full animate-twinkle" style={{ animationDelay: "1.5s" }}></div>
      
      <div className="absolute top-[45%] right-[55%] w-2 h-2 bg-moon-light rounded-full animate-twinkle" style={{ animationDelay: "2.2s" }}></div>
      <div className="absolute top-[47%] right-[53%] w-1 h-1 bg-dream-light rounded-full animate-twinkle" style={{ animationDelay: "2.6s" }}></div>
      ...
      {/* Floating bubbles */}
      <div className="absolute top-[35%] left-[55%] w-8 h-8 rounded-full border-2 border-dream-light/30 animate-float" style={{ animationDelay: "1.8s" }}></div>
      ...
      <div className="absolute top-[80%] right-[45%] w-10 h-10 rounded-full border-2 border-dream-DEFAULT/20 animate-float" style={{ animationDelay: "0.4s" }}></div>
    </div>
  );
};
