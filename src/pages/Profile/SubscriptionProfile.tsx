    ...
    <div className="space-y-6">
      {isPremium ? (
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {/* Monthly Plan Card */}
          <Card className="mx-auto w-full overflow-hidden border-2 border-primary/20">
            <CardHeader>
          ...
          {/* Yearly Plan Card */}
          <Card className="relative mx-auto w-full overflow-hidden border-2 border-primary/30">
