...
const Stories = () => {
  ...
  if (isLoading) {
    return (
      <div
        className="py-4 md:py-8 lg:py-12 px-3 md:px-4"
        dir={isRTL ? "rtl" : "ltr"}
      >
            ...
            {filteredStories.map((story) => {
              ...
              return (
                <Link key={story.id} to={`/stories/${story.id}`}>
                  <Card className="story-card h-80 md:h-96 w-80 overflow-hidden border-dream-light/20 bg-white/70 dark:bg-nightsky-light/70 backdrop-blur-sm cursor-pointer hover:shadow-lg transition-shadow flex flex-col">
                      ...
                      <CardHeader className="p-0 pb-2 flex-1">
                        <div className="flex justify-between items-start mb-2">
                          ...
                          <div className="flex items-center gap-2 ml-2 flex-shrink-0">
                            <Badge
                              variant="secondary"
                              className="bg-dream-light/30 text-dream-DEFAULT text-xs"
                            >
