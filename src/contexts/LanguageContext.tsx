...
const translations = {
  en: {
    ...
    'features.subtitle':
      'Our stories are crafted to bring families together with calming narratives, educational themes, and a touch of magic.',
    'features.soothing.title': 'Soothing Stories',
    'features.soothing.desc':
    ...
    'features.languages.desc':
      'Stories available in English, Arabic, and French to support language development.',
    ...
    'subscribe.subtitle':
      'Get unlimited access to our full library of stories, exclusive content, and special features with our premium subscription.',
  ...
  ar: {
    ...
    'hero.subtitle':
      'اكتشف قصص ما قبل النوم المهدئة بلغات متعددة التي ستأخذ طفلك في مغامرات سحرية أثناء الاستعداد للنوم بسلام.',
    ...
    'features.subtitle':
      'تم تصميم قصصنا لتجمع العائلات معًا بسرديات مهدئة ومواضيع تعليمية ولمسة من السحر.',
    'features.soothing.title': 'قصص مهدئة',
    'features.soothing.desc':
      'سرديات مهدئة مصممة خصيصًا لمساعدة الأطفال على الاسترخاء والاستعداد للنوم.',
    'features.languages.title': 'لغات متعددة',
    'features.languages.desc':
      'قصص متوفرة باللغات الإنجليزية والعربية والفرنسية لدعم تطوير اللغة.',
    'features.games.title': 'ألعاب عائلية',
    'features.games.desc':
      'أنشطة تفاعلية ممتعة يمكن للآباء والأطفال الاستمتاع بها معًا قبل النوم.',
    'subscribe.title': 'افتح القصص والميزات المميزة',
    'subscribe.subtitle':
      'احصل على وصول غير محدود إلى مكتبتنا الكاملة من القصص، والمحتوى الحصري، والميزات الخاصة مع اشتراكنا المميز.',
    ...
    'course.content': 'المحتوى',
    'course.courseVideos': 'فيديوهات الدورة',
    ...
    'toast.upgradeToPremium':
      'يرجى الترقية إلى الاشتراك المميز للوصول إلى هذه الدورة.',
  ...
  fr: {
    ...
    'hero.subtitle':
      'Découvrez des histoires apaisantes pour le coucher en plusieurs langues qui emmèneront votre enfant dans des aventures magiques tout en le préparant à un sommeil paisible.',
    ...
    'features.subtitle':
      'Nos histoires sont conçues pour rassembler les familles avec des récits apaisants, des thèmes éducatifs et une touche de magie.',
    'features.soothing.title': 'Histoires apaisantes',
    'features.soothing.desc':
      'Récits apaisants spécialement conçus pour aider les enfants à se détendre et à se préparer au sommeil.',
    'features.languages.title': 'Langues multiples',
    'features.languages.desc':
      'Histoires disponibles en anglais, arabe et français pour soutenir le développement du langage.',
    'features.games.title': 'Jeux familiaux',
    'features.games.desc':
      'Activités interactives amusantes que les parents et les enfants peuvent apprécier ensemble avant le coucher.',
    'subscribe.title': 'Débloquez des histoires et des fonctionnalités premium',
    'subscribe.subtitle':
      "Accédez sans limite à notre bibliothèque complète d'histoires, à du contenu exclusif et à des fonctionnalités spéciales avec notre abonnement premium.",
    ...
    'course.overview': 'Présentation',
    'course.content': 'Contenu',
    'course.courseVideos': 'vidéos de cours',
    'course.instructor': 'Formateur',
    'course.about': 'À propos de ce cours',
    'course.whatYouLearn': 'Ce que vous apprendrez',
    'course.learnPoint1':
      'Leçons amusantes et interactives adaptées aux enfants',
    'course.learnPoint2':
      "Activités engageantes pour renforcer l'apprentissage",
    ...
    'toast.pleaseLoginToStart':
      'Veuillez vous connecter pour commencer ce cours.',
    'toast.premiumRequired': 'Abonnement premium requis',
    'toast.upgradeToPremium':
      "Veuillez passer à l'abonnement premium pour accéder à ce cours.",
